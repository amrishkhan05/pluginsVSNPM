...
function isImportEqualsDeclaration(node) {
    return node && node.kind === typescript_1.SyntaxKind.ImportEqualsDeclaration;
}
...
function isNamespaceImport(node) {
    return node && node.kind === typescript_1.SyntaxKind.NamespaceImport;
}
...
function isNamedImports(node) {
    return node && node.kind === typescript_1.SyntaxKind.NamedImports;
}
...
function isIdentifier(node) {
    return node && node.kind === typescript_1.SyntaxKind.Identifier;
}
...
function isObjectBindingPattern(node) {
    return node && node.kind === typescript_1.SyntaxKind.ObjectBindingPattern;
}
...
function isArrayBindingPattern(node) {
    return node && node.kind === typescript_1.SyntaxKind.ArrayBindingPattern;
}
...
function isFunctionDeclaration(node) {
    return node && node.kind === typescript_1.SyntaxKind.FunctionDeclaration;
}
...
function isMethodSignature(node) {
    return node && node.kind === typescript_1.SyntaxKind.MethodSignature;
}
...
function isPropertySignature(node) {
    return node && node.kind === typescript_1.SyntaxKind.PropertySignature;
}
...
function isMethodDeclaration(node) {
    return node && node.kind === typescript_1.SyntaxKind.MethodDeclaration;
}
...
function isPropertyDeclaration(node) {
    return node && node.kind === typescript_1.SyntaxKind.PropertyDeclaration;
}
...
function isConstructorDeclaration(node) {
    return node && node.kind === typescript_1.SyntaxKind.Constructor;
}
