...
var WebKitDebugSession = (function (_super) {
    ...
    function WebKitDebugSession(targetLinesStartAt1, isServer) {
        ...
        utilities_1.Logger.init(isServer, function (msg) { return _this.sendEvent(new vscode_debugadapter_1.OutputEvent("  \u203A" + msg + "\n")); });
    ...
    WebKitDebugSession.prototype.sendResponseAsync = function (request, response, responseP) {
        ...
        responseP.then(function (body) {
            ...
            if (eStr === 'Error: unknowncommand') {
                _this.sendErrorResponse(response, 1014, '[NativeScript-Debug-Adapter] Unrecognized request: ' + request.command, null, vscode_debugadapter_1.ErrorDestination.Telemetry);
                return;
            }
